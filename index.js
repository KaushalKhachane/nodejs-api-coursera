...
const books = [
    { ISBN: '123', title: 'Book One', author: 'Author One', review: [], username: "user1" },
    { ISBN: '456', title: 'Book Two', author: 'Author Two', review: [], username: "user2" }
];
...
app.get('/submission', (req, res) => {
    res.send('Project GitHub Link: https://github.com/KaushalKhachane/coursera-shop');
});
